...
class Liqpay extends PaymentModule
{
	...
	public function hookPayment($params)
	{
	  ...
	  /*      global $smarty; */
        $this->smarty->assign(array(
           ...
           /* 'this_description' => 'Payment by system LiqPay',*/
	    'id' => (int)$params['cart']->id,
            ));
          return $this->fetch('liqpay/views/templates/hook/payment.tpl'); 
	}
     	...
     	public function hookPaymentOptions($params)
	{
		...
		/*	'module'        => $this,*/
			'this_path'     => $this->_path,
			'this_path_ssl' => Tools::getShopDomainSsl(true, true).__PS_BASE_URI__.'modules/'.$this->name.'/',
                      /*  'this_description' => 'Payment by System2 LiqPay',*/
			'id' => (int)$params['cart']->id,
		));

		$newOption = new PaymentOption();
                $paymentForm = $this->fetch('module:liqpay/views/templates/hook/payment.tpl');
		$newOption->setCallToActionText('Оплата картой банка', array(), 'Modules.LiqPay.Shop')
                        ->setForm($paymentForm)
